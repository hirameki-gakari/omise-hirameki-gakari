...
const BASE_RESTAURANTS = [
  ...
  },
  {
    ...
    tags:["肉問屋直営"],
    reasonSeeds:{
      budget:["肉問屋直営の焼肉店。予算の目安に対して、肉の量と質で選べる"],
      hearty:["肉問屋直営の焼肉で、がっつり肉尽くし"]
    }
  },
  {
  ...
  {
    id:"koenji-mensaibou", name:"めんさいぼう 五郎左", genre:"ラーメン", area:"南阿佐ヶ谷", vibe:"soloQuick",
...
const NEW_ROWS = [
  ...
  {id:"asagaya-dining-piatto", name:"Dining Piatto", genre:"イタリアン", area:"阿佐ヶ谷", price:[3000,4000], vibe:"budgetCasual",
    ...
    tags:["気軽なイタリアン"], reasonSeeds:{friends:["気取らずに入れる、普段使いのイタリアン"], solo:["ひとりでのふらっと利用もしやすそう"]}},
  ...
  {id:"asagaya-mugi-to-te", name:"麦と手", genre:"台湾まぜそば", area:"阿佐ヶ谷", price:[1000,2000], vibe:"adventurousUnique",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131905/13318205/",
  ...
  {id:"koenji-tomochin", name:"高円寺ともちんラーメン", genre:"ラーメン", area:"高円寺", price:[700,999], vibe:"soloQuick",
    tags:[], reasonSeeds:{}},
  ...
  {id:"koenji-mazesoba-minami", name:"混ぜそば みなみ", genre:"混ぜそば", area:"高円寺", price:[700,999], vibe:"soloQuick",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131904/13183104/",
  ...
  {id:"asagaya-otoriya", name:"音鶏家 阿佐ヶ谷店", genre:"焼き鳥", area:"阿佐ヶ谷", price:[2000,3000], vibe:"budgetCasual",
    ...
    tags:["焼き鳥"], reasonSeeds:{solo:["ひとりでも気軽に立ち寄れる焼き鳥屋"]}},
  ...
  {id:"koenji-en", name:"en", genre:"日本料理", area:"高円寺", price:[5000,6000], vibe:"dateQuiet",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131904/13299127/",
...
const NEW_ROWS2 = [
  ...
  {id:"asagaya-curry-kyu", name:"カレーの店 KYU-", genre:"スパイスカレー", area:"阿佐ヶ谷", price:[700,999], vibe:"soloQuick",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131905/13213364/",
  ...
  {id:"asagaya-beniya", name:"紅屋", genre:"スパイスカレー", area:"阿佐ヶ谷", price:[1000,2000], vibe:"budgetCasual",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131905/13248364/",
  ...
  {id:"asagaya-bansho", name:"鉄板焼ダイニング 万松", genre:"鉄板焼き", area:"阿佐ヶ谷", price:[4000,6000], vibe:"dateQuiet",
    officialUrl:null, reservationUrl:"https://www.hotpepper.jp/strJ003341236/",
  ...
  {id:"koenji-gaucho", hours:"18:00–23:30", closedDays:"火曜日", seats:"テーブル4席、カウンター6席", name:"スペインバル ガウチョ", genre:"スペイン料理", area:"高円寺", price:[3000,4500], vibe:"stylishDrink",
    ...
    tags:["タパス","イカの墨煮"], reasonSeeds:{stylish:["本場スペインバルの空間で、タパスとワインを"], drinking:["アヒージョや肉料理をつまみに、ワインが進む"]}},
  ...
  {id:"asagaya-beard", name:"焼鳥BEARD(ベアード) 南阿佐ヶ谷店", genre:"焼き鳥", area:"南阿佐ヶ谷", price:[4000,5000], vibe:"stylishDrink",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131905/13261326/",
  ...
  {id:"asagaya-kushishinbo", name:"串しん坊", genre:"焼き鳥", area:"阿佐ヶ谷", price:[2000,3000], vibe:"budgetCasual",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131905/13142748/",
  ...
  {id:"asagaya-torinari", name:"とり成", genre:"焼き鳥", area:"阿佐ヶ谷", price:[3000,4000], vibe:"groupCasual",
    officialUrl:null, reservationUrl:"https://www.hotpepper.jp/strJ000142919/",
  ...
  {id:"asagaya-toridokoro", name:"炭火台所 鶏丸", genre:"焼き鳥", area:"阿佐ヶ谷", price:[4000,5000], vibe:"groupCasual",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131905/13023039/",
  ...
  {id:"asagaya-futakun", name:"立呑風太くん", genre:"立ち飲み", area:"阿佐ヶ谷", price:[1000,2000], vibe:"soloDrink",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131905/13056809/",
  ...
  {id:"koenji-shichisuke", name:"立ち飲み七助", genre:"立ち飲み", area:"高円寺", price:[1000,2000], vibe:"soloDrink",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131904/13116372/",
  ...
  {id:"koenji-bar-tail", name:"Bar tail", genre:"バー", area:"高円寺", price:[3000,4000], vibe:"soloDrink",
    tags:["ウイスキー","自家製果実酒"], reasonSeeds:{calm:["年季の入った空間で、静かにウイスキーを傾ける"]}},
  ...
  {id:"koenji-mara", name:"山形料理と地酒 まら", genre:"郷土料理", area:"高円寺", price:[5000,6000], vibe:"adventurousUnique",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131904/13214315/",
...
const NEW_ROWS3 = [
  ...
  {id:"asagaya-sato-brillant-honten", hours:"火・水・木・金・土・日・祝日・祝前日・祝後日 14:30–22:00", closedDays:"月曜日", seats:"24席", name:"SATOブリアン 本店", genre:"焼肉", area:"阿佐ヶ谷", price:[20000,29999], vibe:"dateSpecial",
    ...
    tags:["最高評価クラスの焼肉","希少部位"], reasonSeeds:{indulgent:["地域随一の評価を誇る、特別な日のための焼肉"], couple:["一生に一度クラスの記念日に、思い切って選びたい一軒"]}},
  {id:"asagaya-sato-brillant-nigou", hours:"火・水・木・金・土・日・祝日・祝前日・祝後日 15:00〜22:00", closedDays:"月曜日", seats:"30席", name:"SATOブリアン にごう", genre:"焼肉", area:"阿佐ヶ谷", price:[15000,19999], vibe:"dateSpecial",
    ...
    tags:["高評価焼肉"], reasonSeeds:{indulgent:["本店に迫る評価の高さで、特別な焼肉の夜に"]}},
  {id:"asagaya-sanpoen", name:"炭火焼肉 三宝苑 阿佐ヶ谷店", genre:"焼肉", area:"阿佐ヶ谷", price:[4000,4999], vibe:"familyHearty",
    ...
    tags:["炭火焼き"], reasonSeeds:{hearty:["炭火でじっくり焼く肉を、しっかり楽しめる"], family:["評価の高い炭火焼肉を、みんなで囲む"]}},
  {id:"koenji-araiya-honten", hours:"月～金: 17:00～23:00（料理L.O.22:00 ドリンクL.O.22:00）、土、日、祝日: 12:00～23:00（料理L.O.22:00 ドリンクL.O.22:00）", seats:"総席数27席（5名席×1卓、4名席×2卓、6名席×1卓、カウンター8席）", name:"焼肉ホルモン 新井屋 高円寺本店", genre:"焼肉", area:"高円寺", price:[6000,7999], vibe:"dateSpecial",
    ...
    tags:["ホルモン"], reasonSeeds:{indulgent:["評価の高いホルモン焼肉で、少し贅沢な夜に"]}},
  {id:"asagaya-hasegawa", name:"ほるもんと焼肉屋 はせ川", genre:"焼肉", area:"阿佐ヶ谷", price:[5000,5999], vibe:"groupCasual",
    ...
    tags:["ホルモン"], reasonSeeds:{friends:["ホルモンと焼肉、両方楽しめて盛り上がれる"]}},
  {id:"koenji-tamaniha-yakiniku", name:"たまには焼肉 高円寺店", genre:"焼肉", area:"高円寺", price:[3000,3800], vibe:"budgetCasual",
    ...
    tags:["コスパの良い肉質"], reasonSeeds:{budget:["「たまには」の名の通り、気張らずコスパよく焼肉を"]}},
  ...
  {id:"asagaya-spice-and-booze", name:"SPICE AND BOOZE", genre:"スパイスカレー", area:"阿佐ヶ谷", price:[1000,2000], vibe:"adventurousUnique",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131905/13295702/",
  ...
  {id:"koenji-3b", name:"焼き鳥とワイン ビストロおでん 3B 高円寺", genre:"焼き鳥・おでん", area:"高円寺", price:[4000,4999], vibe:"stylishDrink",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131904/13318100/",
  ...
  {id:"koenji-manmajima", name:"まんまじぃま", genre:"藁炙り料理", area:"高円寺", price:[3000,4999], vibe:"adventurousUnique",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131904/13171225/",
...
const NEW_ROWS4 = [
  ...
  {id:"asagaya-agariko-gyozaro", name:"アガリコ餃子楼 阿佐ヶ谷店", genre:"中華(餃子)", area:"阿佐ヶ谷", price:[2000,3000], vibe:"groupCasual",
    ...
    tags:["餃子"], reasonSeeds:{friends:["餃子を何皿もシェアしながら、わいわい飲める"]}},
  {id:"asagaya-chugoku-meisai-son", name:"中國名菜 孫 阿佐ヶ谷店", genre:"中華", area:"阿佐ヶ谷", price:[3000,4000], vibe:"groupCasual",
    ...
    tags:[], reasonSeeds:{friends:["口コミの多さも納得の、本格中華をみんなで"]}},
  {id:"asagaya-wantantei", name:"阿佐ヶ谷 わんたん亭", genre:"中華", area:"阿佐ヶ谷", price:[2000,3000], vibe:"soloQuick",
    ...
    tags:["ワンタン"], reasonSeeds:{quick:["ワンタンを中心に、さっと食べられる中華"]}},
  {id:"asagaya-suikai", hours:"11:30〜14:30(L.O.14:00)、17:30〜22:00(L.O.21:30)", seats:"56席", name:"中国料理 翠海", genre:"中華", area:"阿佐ヶ谷", price:[2000,3000], vibe:"groupCasual",
    ...
    tags:[], reasonSeeds:{friends:["このエリアの中華の中でも評価の高い一軒"]}},
  {id:"koenji-chengdu-honten", hours:"11:00〜23:00（ラストオーダー22:30）", name:"中華料理 成都 高円寺本店", genre:"中華", area:"高円寺", price:[3000,4000], vibe:"groupCasual",
    ...
    tags:["圧倒的な人気"], reasonSeeds:{friends:["口コミ1万件超という圧倒的な人気を誇る中華の名店"], drinking:["中華とお酒の組み合わせで、盛り上がる夜に"]}},
  ...
  {id:"koenji-dapaidan105", name:"ダパイダン105 高円寺東京本店", genre:"台湾料理", area:"高円寺", price:[2000,3000], vibe:"adventurousUnique",
    officialUrl:null, reservationUrl:"https://www.hotpepper.jp/strJ001285787/",
  ...
  {id:"koenji-futaba", name:"とんかつ二葉", genre:"とんかつ", area:"高円寺", price:[700,999], vibe:"soloQuick",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131904/13133148/",
  ...
  {id:"koenji-matsunaga", name:"とんかつ 松永", genre:"とんかつ", area:"高円寺", price:[1000,2000], vibe:"soloQuick",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131904/13048636/",
  ...
  {id:"koenji-odoridori", name:"高円寺おどり鳥", genre:"焼き鳥", area:"高円寺", price:[6000,8000], vibe:"dateSpecial",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131904/13321544/",
  ...
  {id:"koenji-torisuke", name:"とりすけ", genre:"焼き鳥", area:"高円寺", price:[4000,5000], vibe:"groupCasual",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131904/13296493/",
  ...
  {id:"koenji-daichi-sushi-yakitori", name:"寿司と焼き鳥 大地 高円寺店", genre:"焼き鳥", area:"高円寺", price:[3000,4000], vibe:"groupCasual",
    ...
    tags:["寿司と焼き鳥"], reasonSeeds:{friends:["寿司も焼き鳥もある、選択肢の広さが嬉しい"]}},
  ...
  {id:"koenji-tomimaru", name:"焼きとり おでん 富まる", genre:"焼き鳥・おでん", area:"高円寺", price:[2000,3000], vibe:"budgetCasual",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131904/13301204/",
  ...
  {id:"koenji-tori-jiro", name:"炭火串焼 鶏ジロー 新高円寺店", genre:"焼き鳥", area:"高円寺", price:[2000,3000], vibe:"budgetCasual",
    officialUrl:null, reservationUrl:"https://tabelog.com/tokyo/A1319/A131904/13122658/",
  ...
  {id:"asagaya-cincirella", name:"ジェラテリア シンチェリータ", genre:"ジェラート", area:"阿佐ヶ谷", price:[700,999], vibe:"soloQuick",
    tags:["圧倒的人気"], reasonSeeds:{quick:["口コミ1,700件超、このエリア随一の人気ジェラート"], solo:["食後にひとりでふらっと寄れるジェラート店"]}},
  {id:"asagaya-tomoean", hours:"11:00–19:30", closedDays:"無休", name:"ともえ庵", genre:"たい焼き", area:"阿佐ヶ谷", price:[700,999], vibe:"soloQuick",
    ...
    tags:["たい焼き"], reasonSeeds:{quick:["食後の締めに、たい焼きをひとつ"]}},
  {id:"asagaya-gyunyuya-soft", hours:"平日 11:00〜18:00、土日祝 11:00〜18:30", closedDays:"不定休", name:"牛乳屋さんのソフトクリーム", genre:"ソフトクリーム", area:"阿佐ヶ谷", price:[700,999], vibe:"soloQuick",
    ...
    tags:[], reasonSeeds:{quick:["濃厚なソフトクリームで、軽く締めくくる"]}},
  {id:"koenji-lapre-cochere", hours:"11:00〜18:00", notice:"公式サイトによると、イートイン（店内飲食）は現在休止中で再開時期は未定。販売自体は営業中とみられる（閉店の記載なし）。", name:"パティスリー ラブリコチエ", genre:"ケーキ", area:"高円寺", price:[700,999], vibe:"dateQuiet",
    ...
    tags:[], reasonSeeds:{couple:["口コミ912件という評判のケーキを、ふたりで分け合う締めくくりに"]}},
  {id:"koenji-trianon", hours:"10:00–20:00（L.O.19:30）", closedDays:"無休", seats:"総席数50席", name:"トリアノン洋菓子店 高円寺本店", genre:"洋菓子", area:"高円寺", price:[700,999], vibe:"familyHearty",
    ...
    tags:["老舗"], reasonSeeds:{family:["地元で長く愛される洋菓子店、家族の締めくくりに"]}},
  ...
  {id:"koenji-millineyangkopchang", hours:"月～金、祝前日: 17:00～23:00（料理L.O.22:15 ドリンクL.O.22:30）、土、日、祝日: 12:00～23:00（料理L.O.22:15 ドリンクL.O.22:30）", seats:"総席数41席（最大宴会収容人数53人）", name:"ミリネヤンコプチャン 高円寺店", genre:"韓国料理", area:"高円寺", price:[4000,5000], vibe:"groupCasual",
    ...
    tags:["京都ミシュラン掲載の技"], reasonSeeds:{friends:["ミシュラン掲載店仕込みの技を、みんなで楽しめる"], drinking:["ホルモンをつまみに、じっくり飲める夜に"]}},
...
const NEW_ROWS5 = [
  ...
  {id:"asagaya-gion", name:"ギオン", genre:"喫茶店", area:"阿佐ヶ谷", price:[1000,2000], vibe:"dateQuiet",
    tags:["老舗喫茶"], reasonSeeds:{calm:["口コミ600件近い、地元で愛される老舗喫茶"]}},
  ...
  {id:"asagaya-panda-coffee", name:"ぱんだ珈琲店", genre:"カフェ", area:"阿佐ヶ谷", price:[1000,2000], vibe:"soloQuick",
    tags:[], reasonSeeds:{solo:["ひとりでふらっと寄れる、地域で人気の珈琲店"]}},
  ...
  {id:"koenji-nanatsumori", name:"七つ森", genre:"喫茶店", area:"高円寺", price:[1000,2000], vibe:"dateQuiet",
    tags:[], reasonSeeds:{calm:["口コミ600件超、地域屈指の人気喫茶店"]}},
  {id:"koenji-poeme-mano", hours:"月・水・木・金: 10:00～19:00、土・日・祝日: 09:30～19:00", closedDays:"火曜", seats:"26席（カウンター8席、テーブル席2名掛け×1・4名掛け×4）", name:"ぽえむ マノ ア マノ コーヒー 高円寺南口店", genre:"喫茶店", area:"高円寺", price:[2000,3000], vibe:"dateQuiet",
    ...
    tags:[], reasonSeeds:{couple:["じっくり淹れるコーヒーを、ふたりでゆっくり"]}},
  {id:"koenji-rad-bros", name:"RAD BROS CAFE", genre:"カフェ", area:"高円寺", price:[1000,2000], vibe:"groupCasual",
    tags:[], reasonSeeds:{friends:["賑やかな雰囲気で、友達との時間にちょうどいい"]}},
  ...
  {id:"koenji-aimu", name:"AIMU", genre:"カフェ", area:"高円寺", price:[1000,2000], vibe:"dateQuiet",
    tags:[], reasonSeeds:{calm:["落ち着いた空間で、静かに会話を楽しめる"]}},
  {id:"koenji-neyo", name:"NEYO", genre:"カフェ", area:"高円寺", price:[1000,2000], vibe:"groupCasual",
    tags:[], reasonSeeds:{friends:["友達と気軽に立ち寄れる人気カフェ"]}},
  ...
  {id:"koenji-taw", name:"TAW.", genre:"カフェ", area:"高円寺", price:[1000,2000], vibe:"dateQuiet",
    tags:[], reasonSeeds:{calm:["シンプルで洗練された空間で、ゆっくり過ごせる"]}},
  ...
  {id:"koenji-kuronbo", name:"クロンボ", genre:"洋食", area:"高円寺", price:[700,999], vibe:"soloQuick",
    ...
    tags:["エリア最安値帯"], reasonSeeds:{budget:["このエリアの洋食では最安値クラス、気負わずさっと入れる"]}},
  ...
  {id:"asagaya-toraya-tsubakiyama", hours:"09:30–19:00", seats:"総席数34席", name:"とらや椿山", genre:"和菓子", area:"阿佐ヶ谷", price:[700,999], vibe:"soloQuick",
    ...
    tags:["和菓子"], reasonSeeds:{quick:["食後の甘味に、和菓子をひとつ"]}},
  {id:"koenji-patissier-junhomma", hours:"10:00〜20:00", closedDays:"月曜日", name:"パティシエ ジュン ホンマ 高円寺", genre:"ケーキ", area:"高円寺", price:[700,999], vibe:"dateQuiet",
    ...
    tags:[], reasonSeeds:{couple:["口コミ201件でも根強い人気のケーキを、ふたりで分け合う締めくくりに"]}},
...
const NEW_ROWS6 = [
  ...
  {id:"koenji-patisserie-copeau", name:"パティスリー コポー", genre:"ケーキ", area:"高円寺", price:[700,999], vibe:"dateQuiet",
    tags:[], reasonSeeds:{calm:["丁寧に作られたケーキで、静かな締めくくりを"]}},
